                        ...
                        <div className="bg-white/5 dark:bg-surface-dark/60 backdrop-blur-xl border border-white/10 dark:border-white/5 shadow-2xl rounded-2xl p-8 sm:p-10 flex flex-col gap-6">
                            ...
                            <form className="flex flex-col gap-5" onSubmit={handleLogin}>
                                <div className="space-y-2">
                                    <label className="text-sm font-medium text-slate-700 dark:text-slate-200" htmlFor="username">Username / Email</label>
                                    <div className="relative flex items-center">
                                        <span className="absolute left-4 text-slate-500 material-symbols-outlined" style={{ fontSize: '20px' }}>person</span>
                                        <input
                                            className="w-full pl-11 pr-4 py-3.5 bg-slate-50 dark:bg-[#111814] border border-slate-200 dark:border-white/10 rounded-lg text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all text-sm"
                                            id="username"
                                            name="username"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative flex items-center group">
                                        ...
                                        <input
                                            className="w-full pl-11 pr-11 py-3.5 bg-slate-50 dark:bg-[#111814] border border-slate-200 dark:border-white/10 rounded-lg text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all text-sm"
                                            id="password"
                                            name="password"
                                ...
                                <button
                                    className="mt-2 w-full bg-primary hover:bg-[#15cf5f] text-background-dark font-bold py-3.5 px-4 rounded-lg transition-all duration-200 shadow-[0_0_20px_rgba(25,230,107,0.3)] hover:shadow-[0_0_25px_rgba(25,230,107,0.5)] flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                    type="submit"
                                    disabled={loading}
                                >
                                    {loading ? 'Logging in...' : (
