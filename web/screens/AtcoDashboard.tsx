                ...
                <header className="sticky top-0 z-30 w-full bg-[#111814]/90 backdrop-blur-md border-b border-border-dark">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 px-6 py-4 max-w-[1400px] mx-auto w-full">
                        ...
                        <div className="flex items-center gap-4">
                            ...
                            <Link to="/submission" className="relative z-50 flex items-center justify-center rounded-lg h-10 px-5 bg-primary hover:bg-primary/90 text-[#111814] gap-2 text-sm font-bold tracking-wide transition-all shadow-[0_0_15px_rgba(25,230,107,0.3)] hover:shadow-[0_0_20px_rgba(25,230,107,0.5)] whitespace-nowrap">
